...
setup(
    name='certbot-dns-checkdomain',
    version=version,
    description="CheckDomain DNS Authenticator plugin for Certbot",
    ...
    entry_points={
        'certbot.plugins': [
            'dns-checkdomain = certbot_dns_checkdomain.dns_checkdomain:Authenticator',
        ],
    },
    test_suite='certbot_dns_checkdomain',
)
